...
def main():
    ...
    for device in devices_for_work:
        ...
        devcom.append_coroutine(comrun1.set_status_interfaces('disable'))
        # devcom.append_coroutine(comrun1.set_status_interfaces('print'))
    devcom.run()
    ...
    # for device in devices_for_work:
    #     comrun1 = dc.CommandRunner_Put(device)
    #     devcom.append_coroutine(comrun1.set_status_interfaces('enable'))
    # devcom.run()
